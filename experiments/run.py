...
from .utils import collect_anomaly_scores, compute_val_loss, predict_segment
...
def run(
    ...
    # 이상 라벨 생성
    full_labels = create_anomaly_labels(ts, csv_path, json_path=anomaly_windows_json)
    ...
    for w in w_candidates:
        ...
        val_loss = compute_val_loss(predictor, val_loader, device, criterion)
